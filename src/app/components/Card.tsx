...
function Card(props: { card: CardType }) {
  ...
  return (
    <div className="min-w-56 rounded-lg border border-primary-st bg-background-li px-1 py-4 shadow-lg transition duration-500 hover:scale-1 sm:min-w-64 sm:px-4">
